...
const preparationSteps = [
  { number: '01', title: 'Prepare', text: 'Create and organize Scripture-based quizzes.' },
...
const experiences = [
  ...
  { title: 'Projector', text: 'Share the experience with the whole room.' },
];
    ...
    <div className="bg-[var(--barea-midnight)] text-[var(--barea-ivory)]">
      <section className="relative flex min-h-[calc(100svh-4.5rem)] items-center justify-center overflow-hidden border-b border-[var(--barea-slate-border)] px-5 py-20 sm:px-8 lg:px-12">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center text-center">
          <p className="mb-10 text-[0.65rem] font-bold uppercase tracking-[0.28em] text-[var(--barea-gold)] sm:text-xs">
            Church quiz &amp; Scripture platform
          </p>
          <ScriptureTypewriter />
          <p className="mt-7 text-xs font-bold uppercase tracking-[0.32em] text-[var(--barea-ivory-muted)] sm:text-sm">
            Prepare. Learn. Share.
          </p>
      ...
      <section id="how-it-works" className="border-b border-[var(--barea-slate-border)] bg-[var(--barea-paper-dark)] px-5 py-16 sm:px-8 lg:px-12 lg:py-24">
        <div className="mx-auto max-w-6xl">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 font-serif text-3xl tracking-tight text-white sm:text-4xl">Technology assists. People review.</h2>
            <p className="mt-4 text-sm leading-6 text-[var(--barea-ivory-muted)]">BAREA keeps question review in human hands before questions are approved for use.</p>
          </div>
        </div>
      </section>
