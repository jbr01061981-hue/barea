...
export interface RateLimiter {
  checkRoomLookup(clientIp: string): void;
  recordFailedLookup(clientIp: string): void;
  checkUnauthenticatedRequest(clientIp: string): void;
...
export class InMemoryRateLimiter implements RateLimiter {
  ...
  private maxUnauthRequestsPer10Seconds: number = 30;
